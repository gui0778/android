...
public final class Utils {
    ...
    public static int crc16(ChannelBuffer buf) {
    	int si = buf.readerIndex();
	...
	public static byte[] concatArray(byte[]... args) {
	 ...
	 public static String toHexString(long val, int bitLen)
	    ...
	    **/
	    ...
	    {
	        return Utils.toHexString(val, 64);
	    }
	    ...
	    **/
	    ...
	    {
	        return Utils.toHexString((long)val & 0xFFFFFFFF, 32);
	    }
